...
/*   Updated: 2022/08/10 10:07:35 by fmauguin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
#define TEST(A, C, sp) \
TITLE("Test fillList and overflow list  with " << #A <<  " iterator"); \
			PRINT(BLUE "fill" STOPC); \
			sp.fillList(C.begin(), C.end()); \
